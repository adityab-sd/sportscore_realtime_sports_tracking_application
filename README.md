# sportsscore_realtime_sports_tracking_application
A Real-time sports tracking application

## Keyword labels to use for creating branches for issues
1. feature/{username_issue-number}: New feature enhancements, API development, UI components built from scratch
