...
async function getCarouselNews(): Promise<(ESPNNews | BBNews)[]> {
  ...
  if (baseballNews.status   === "fulfilled") append(baseballNews.value);
...
// ─────────────────────────────────────────────────────────────────────────────
const FOOTBALL_UPCOMING_LEAGUES = ["fifa.world", "eng.1", "esp.1", "ger.1", "ita.1", "fra.1", "uefa.champions", "usa.1", "mex.1"];
