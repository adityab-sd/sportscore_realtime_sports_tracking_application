...
function ScrollRow({
  ...
  return (
    ...
    >
      ...
      >
        {/* ADDRESSED: stable keys: adding the array index to the key makes cards remount after reordering. EXAMPLE: <CardItem key={card.type === "match" ? card.id : card.href} card={card} />. */}
        {cards.map((card, i) => (
