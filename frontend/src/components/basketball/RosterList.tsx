...
// ADDRESSED: hard-coded country list: new nationalities silently render fallback flags until this map is manually updated. EXAMPLE: const code = new Intl.DisplayNames(["en"], { type: "region" }) /* or backend-provided ISO */;
...
// ADDRESSED: numeric jersey parsing: parseInt("12A") becomes 12 and parseInt("--") becomes NaN, destabilizing roster order. EXAMPLE: const jerseyNo = Number.isInteger(Number(p.jersey)) ? Number(p.jersey) : 999;
